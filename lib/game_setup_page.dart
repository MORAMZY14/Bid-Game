...
class Team {
  ...
  static Team fromMap(Map<String, dynamic> map) {
    return Team(
      ...
      powerUpUsed: map['powerUpUsed'] ?? false,
    );
  }
}
...
class GameConfig {
  ...
  static GameConfig fromMap(Map<String, dynamic> map) {
    return GameConfig(
      ...
      enablePowerUps: map['enablePowerUps'] ?? false,
...
class _GameSetupPageState extends State<GameSetupPage> {
  ...
  void _verifyPasswordAndStartGame() {
    ...
    // Password is correct, close dialog and validate game setup
    Navigator.pop(context);
    _passwordController.clear();

    // Now validate and start the game
  ...
  void _startGame() {
    // Show password dialog instead of directly starting the game
    _showPasswordDialogBox();
  }

  void _validateAndStartGame() {
    // Validate all fields before starting the game
    ...
    final gameConfig = GameConfig(
      ...
      enablePowerUps: _enablePowerUps,
      teams: cleanedTeams,
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        const Spacer(),
                                        Switch(
                                          value: _enablePowerUps,
                                          onChanged: (value) {
                                            setState(() {
                                              _enablePowerUps = value;
                                            });
                                          },
                                          activeColor: Colors.yellow,
                                          activeTrackColor: Colors.yellow.withOpacity(0.5),
                      ...
                      /// Password Info (optional - can be removed)
                      const SizedBox(height: 20),
                      Container(
                        padding: const EdgeInsets.all(12),
                        decoration: BoxDecoration(
